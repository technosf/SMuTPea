 ...
 * <p>
 * Designed as a per-session call-back interface for behavioral-specifics, with the majority of the (well-defined)
 * REF2821 work done in the framework by session.
 * 
...
public interface MTA
{
	...
	/**
	 * Process the given commandLine based on the current session state, preparing and setting a reply.
	 * <p>
	 * The reply (code and description) is generated by the implementing class and retrieved using
	 * <code>getReplyCode</code> and <code>getReplyDescription</code>.
	 * 
	 * @param commandLine
	...
	/**
	 * Process the send MAIL, per the MTA implementation, derived from Session StateTable and Buffer.
	 * <p>
	 ...
	 * <p>
	 * The response is generated by the implementing class and is used in the reply to the call to the MTA from the SMTP
	 * client.
	 * 
	 ...
	 * <p>
	 * The reply code is generated by the implementing class and is used in the reply to the call to the MTA from the
	 * SMTP client.
	 * 
	 ...
	 * <p>
	 * The response description is generated by the implementing class and is used in the response to the call to the
	 * MTA from the SMTP client.
	 * 
