 ...
 * @version 0.0.1
 */
public enum ReplyCodes implements ReplyCode
{
    /*
     ...
     * Index of codes
     */
    private static final Map<Integer, ReplyCodes> codeIndex =
            new HashMap<Integer, ReplyCodes>();
    ...
    {
        for (ReplyCodes replyCode : ReplyCodes.values())
        {
     ...
     *            response message
     */
    ReplyCodes(int code, String description)
    {
        this.code = code;
     ...
     */
    public static ReplyCodes findReplyCode(int code)
    {
