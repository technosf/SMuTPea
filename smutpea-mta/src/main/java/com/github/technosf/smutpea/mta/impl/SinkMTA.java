 ...
 * or email addresses is done - everything is accepted so that to the client,
 * everything looks OK unless the client violates the RFC.
 * 
 * @author technosf
 * @since 0.0.1
 * @version 0.0.1
        ...
        implements MTA
{
    ...
    protected final void sendMessage(final String message)
    {
        ...
        setResponse(ReplyCode._250,
                String.format("%1$s %2$s", getReplyCode().getCode(), // TODO validate
